...
columns = [
    {"name": col, "id": col, "presentation": "markdown", "type": "text"} 
    if col in column_hyperlinks else {"name": col, "id": col, "type": "text"} 
    for col in df.columns
]

columns = [
    {"name": col, "id": col, "editable": True if col == 'Affiliation' else False, "presentation": "markdown", "type": "text"}
    if col in column_hyperlinks else {"name": col, "id": col, "editable": True if col == 'Affiliation' else False, "type": "text"}
    for col in df.columns
]

            ...
            html.Div(className='col-md-4', children=[
                html.Div(className='row', children=[
                    html.Div(className='col', id='webscrape-button-div', style={'display': 'none'}, children=[
                        html.Button('Webscrape New Instance', id='webscrape-button', className='btn btn-primary me-2')
                    ]),
...
@async_to_sync
async def perform_upload(n_clicks_button, n_clicks_submit, n_clicks_custom, n_clicks_submit_custom,
    ...
    if n_clicks_button is None and n_clicks_submit is None and n_clicks_custom is None and n_clicks_submit_custom is None:
        raise PreventUpdate
    ...
    return loading_output, modal_is_open, instance_value, options, selected_value, loading_output_custom, modal_is_open_custom, instance_value_custom
